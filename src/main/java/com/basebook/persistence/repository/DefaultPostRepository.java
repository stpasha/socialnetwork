...
public class DefaultPostRepository implements PostRepository {
    ...
    private Like mapLike(final ResultSet rs) throws SQLException {
        return Like.builder()
    ...
    private Comment mapComment(final ResultSet rs) throws SQLException {
    ...
    @Override
    public List<PostList> findAll(final int limit, final int offset, final String filter) {
        String sql;
